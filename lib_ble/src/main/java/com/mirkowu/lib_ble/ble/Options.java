...
public class Options {
    ...
    public <T extends BleDevice> BleManager<T> create(Context context) {
        return create(context, null);
    }

    public <T extends BleDevice> BleManager<T> create(Context context, BleManager.InitCallback callback) {
        return BleManager.create(context, callback);
    }
